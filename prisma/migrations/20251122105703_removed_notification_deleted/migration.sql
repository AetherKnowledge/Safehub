/*
  ...
  - The values [AppointmentCancelled] on the enum `NotificationType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."NotificationType_new" AS ENUM ('AppointmentCreated', 'AppointmentUpdated', 'AppointmentReminder', 'NewPost');
